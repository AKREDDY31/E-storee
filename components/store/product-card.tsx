    ...
    <article className="card" style={{ overflow: "hidden", background: "linear-gradient(180deg, rgba(255,255,255,0.96), rgba(247,244,238,0.96))" }}>
      ...
      <div style={{ padding: 20, display: "grid", gap: 12 }}>
        ...
        <div style={{ display: "flex", alignItems: "baseline", gap: 10, flexWrap: "wrap" }}>
          <strong style={{ fontSize: 28 }}>{formatCurrency(product.price)}</strong>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
          ...
          <Link
            ...
            href={buildWhatsAppOrderLink(product.name, product.price, whatsappNumber, { productUrl, customerAddress })}
          >
            WhatsApp
          </Link>
        </div>
